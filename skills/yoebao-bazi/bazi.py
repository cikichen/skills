...
Attribution:
- Source: https://github.com/openclaw/skills/tree/main/skills/kinmeic/yoebao-bazi (MIT)
- Related upstream noted for license caution: https://github.com/Wolke/bazi-mingli (CC BY-NC-SA 4.0)
- This local file currently contains no direct copied code from Wolke/bazi-mingli.
"""
